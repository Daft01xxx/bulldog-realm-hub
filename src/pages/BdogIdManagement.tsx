...
const BdogIdManagement = () => {
  ...
  const handleSendCode = async () => {
    ...
    try {
      ...
      // Show success message with note about checking logs if email wasn't sent
      if (data?.note) {
        toast.success(`Код: ${data.code}`, {
          description: 'Email не настроен. Используйте этот код для верификации.',
          duration: 10000,
        });
      } else {
